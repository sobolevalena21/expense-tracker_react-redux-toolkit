...
export default function Transaction({ transaction, budget }) {
  ...
  return (
    <li className="new-transaction">
      <span>
        {transaction.date} | {transaction.traderId} | {transaction.action} | {transaction.amount} | {transaction.stock} | 'remainingFunds'
      </span>
